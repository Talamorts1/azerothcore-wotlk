...
public: /* UnitScript */
    ...
    void OnDamage(Unit* attacker, Unit* victim, uint32& damage, DamageEffectType damagetype, SpellInfo const* spellProto);
    ...
    void ModifySpellPowerCost(Unit* caster, SpellInfo const* spellInfo, int32& powerCost);
    ...
    void OnKillRewardAllowed(Unit* killer, Unit* victim, bool& isAllowedReweard, Player*& player);
